...
<table><tr>
    ...
    <td>
      <a href="https://github.com/conda-forge/toppra-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/toppra-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
...
pixi add libtoppra toppra-python
# for installing globally
pixi global install libtoppra toppra-python
```
...
It is possible to list all of the versions of `libtoppra` available on your platform:
...
```
pixi search libtoppra --channel conda-forge
```
